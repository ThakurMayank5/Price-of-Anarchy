"""
Thompson Sampling Bandit Agent on Braess's Network
====================================================

Applies the Thompson Sampling multi-armed bandit approach from
``thompson_sampling_agent.py`` to the classical Braess network.
...
if __name__ == '__main__':
    ...
    print("=" * 65)
    print("  Thompson Sampling Bandit Simulation on BRAESS'S NETWORK")
    print("=" * 65)
    print()
