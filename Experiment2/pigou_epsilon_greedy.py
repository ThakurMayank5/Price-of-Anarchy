"""
Epsilon-Greedy Bandit Agent on Pigou's Network
===============================================

Applies the epsilon-greedy multi-armed bandit approach from
``epsilon_greedy_agent.py`` to the classical Pigou network.
...
if __name__ == '__main__':
    ...
    print("=" * 65)
    print("  Epsilon-Greedy Bandit Simulation on PIGOU'S NETWORK")
    print("=" * 65)
    print()
