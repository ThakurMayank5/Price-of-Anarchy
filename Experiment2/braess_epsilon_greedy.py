"""
Epsilon-Greedy Bandit Agent on Braess's Network
================================================

Applies the epsilon-greedy multi-armed bandit approach from
``epsilon_greedy_agent.py`` to the classical Braess network.
...
from epsilon_greedy_agent import (
    EpsilonGreedyAgent,
    get_all_paths,
    compute_flow_dict,
...
if __name__ == '__main__':
    ...
    print("=" * 65)
    print("  Epsilon-Greedy Bandit Simulation on BRAESS'S NETWORK")
    print("=" * 65)
    print()
